...
BEGIN
  ...
  IF NOT EXISTS (SELECT 1 FROM auth.users WHERE email = 'comercial@areradigital.com.br') THEN
    ...
    VALUES (new_user_id, 'comercial@areradigital.com.br', 'Comercial', 'admin', true)
