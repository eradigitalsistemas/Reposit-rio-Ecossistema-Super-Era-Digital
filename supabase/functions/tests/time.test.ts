...
describe('Time Calculations', () => {
  ...
  describe('calculateTimeEntry', () => {
    ...
    it('should throw error if exit is before entry', () => {
      expect(() => calculateTimeEntry('17:00', '08:00', '01:00')).toThrow(/Horário de saída não pode ser menor/);
    });

    it('should throw error if break makes hours negative', () => {
      expect(() => calculateTimeEntry('08:00', '09:00', '02:00')).toThrow(/Horário fora do expediente ou intervalo inválido/);
    });
  });
});
