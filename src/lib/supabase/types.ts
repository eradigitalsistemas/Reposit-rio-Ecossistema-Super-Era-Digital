...
// Table: configuracoes
//   FOREIGN KEY configuracoes_atualizado_por_fkey: FOREIGN KEY (atualizado_por) REFERENCES auth.users(id) ON DELETE SET NULL
...
//     WITH CHECK: is_admin()
// Table: configuracoes
//   Policy "Admins gerenciam configuracoes" (ALL, PERMISSIVE) roles={authenticated}
//     USING: is_admin()
//     WITH CHECK: is_admin()
//   Policy "Colaboradores leem configuracoes" (SELECT, PERMISSIVE) roles={authenticated}
//     USING: true
// Table: cron_logs
