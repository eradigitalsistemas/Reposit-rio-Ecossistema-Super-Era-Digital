...
// --- TRIGGERS ---
// Table: demandas
//   set_public_demandas_updated_at: CREATE TRIGGER set_public_demandas_updated_at BEFORE UPDATE ON public.demandas FOR EACH ROW EXECUTE FUNCTION set_updated_at_timestamp()
// Table: emails_sent
