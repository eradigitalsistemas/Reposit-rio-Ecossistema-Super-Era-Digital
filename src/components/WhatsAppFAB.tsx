...
export function WhatsAppFAB() {
  ...
  return (
    <Button
      ...
      className={cn(
        'fixed bottom-6 right-6 h-14 w-14 rounded-full shadow-lg bg-green-600 hover:bg-green-700 z-50 transition-transform hover:scale-105 active:scale-95 group',
