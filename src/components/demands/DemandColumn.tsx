  ...
  return (
    <div className="flex flex-col h-full max-h-full w-[350px] shrink-0 bg-slate-100/50 dark:bg-slate-900/50 rounded-xl border border-border/50">
      <div className="flex items-center justify-between p-4 border-b border-border/50">
        <h3 className="font-semibold text-sm text-foreground">{collaborator}</h3>
        <span className="bg-background text-foreground shadow-sm text-xs font-semibold px-2.5 py-0.5 rounded-full border">
          {demands.length}
        </span>
      </div>
